...
class Settings(BaseSettings):
    ...
    # =========================================================
    lane1_max_compensation_usd: float = Field(default=100.0, alias="LANE1_MAX_COMPENSATION_USD")
    ...
    claim_frequency_window_days: int = Field(default=30, alias="CLAIM_FREQUENCY_WINDOW_DAYS")
